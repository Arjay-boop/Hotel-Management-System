		...
		<div class="sidebar" id="sidebar">
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="active"> <a href="{{ route('housekeeper.home') }}"><i class="fas fa-home"></i> <span>Dashboard</span></a> </li>
						<li class="list-divider"></li>
						<li> <a href="{{ route('housekeeper.rooms') }}"><i class="fas fa-key"></i> <span>Room</span></a> </li>
					</ul>
				</div>
			</div>
		</div>
