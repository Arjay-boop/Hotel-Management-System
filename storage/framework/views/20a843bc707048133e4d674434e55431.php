...
<div id="addEventModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="addEventForm" action="<?php echo e(route('admin.store-event')); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="lodge_id" id="lodge_id" class="form-control">
                            ...
                            <?php $__currentLoopData = $lodge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodges): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($lodges->lodge_id); ?>"><?php echo e($lodges->area); ?></option>
...
<script>
    ...
    function addEvent(event) {
        ...
        fetch('<?php echo e(route("admin.store-event")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HMS\resources\views/Admin/calendar.blade.php ENDPATH**/ ?>