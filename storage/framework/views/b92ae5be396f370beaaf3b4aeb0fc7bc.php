    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12 mt-5">
                <h3 class="page-title mt-3">Good Morning <?php echo e($fullname); ?>!</h3>
                <ul class="breadcrumb">
            ...
            <div class="card board1 fill">
                <div class="card-body">
                    <div class="dash-widget-header">
                        <div>
                            <h3 class="card_widget_header"><?php echo e($totalBookings); ?></h3>
        ...
        <div class="col-xl-3 col-sm-6 col-12">
            <div class="card board1 fill">
                <div class="card-body">
                    <div class="dash-widget-header">
                        <div>
                            <h3 class="card_widget_header"><?php echo e($totalRevenue); ?></h3>
        ...
        <div class="col-xl-3 col-sm-6 col-12">
            <div class="card board1 fill">
                <div class="card-body">
                    <div class="dash-widget-header">
                        <div>
                            <h3 class="card_widget_header"><?php echo e($totalOccupancy); ?></h3>
        ...
        <div class="col-xl-3 col-sm-6 col-12">
            <div class="card board1 fill">
                <div class="card-body">
                    <div class="dash-widget-header">
                        <div>
                            <h3 class="card_widget_header"><?php echo e(number_format($averageRate, 2)); ?></h3>
...
<script>
    ...
    var occupancyChart = new Chart(ctxOccupancy, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($datas['labels']); ?>,
            datasets: <?php echo json_encode($datas['datasets']); ?>
    ...
    var guestsChart = new Chart(ctxGuests, {
        type: 'pie',
        data: <?php echo json_encode($guestsChartData); ?>,
        options: {
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HMS\resources\views/Admin/admin-dashboard.blade.php ENDPATH**/ ?>