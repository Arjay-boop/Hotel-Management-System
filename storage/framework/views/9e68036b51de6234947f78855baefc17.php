		...
		<div class="sidebar" id="sidebar">
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="active"> <a href="<?php echo e(route('admin.home')); ?>"><i class="fas fa-home"></i> <span>Dashboard</span></a> </li>
						<li class="list-divider"></li>
						<li> <a href="<?php echo e(route('admin.lodges')); ?>"><i class="fas fa-suitcase"></i> <span>Lodge Area</span></a> </li>
						<li> <a href="<?php echo e(route('admin.room')); ?>"><i class="fas fa-key"></i> <span>Room</span></a> </li>
						<li> <a href="<?php echo e(route('admin.employee')); ?>"><i class="fas fa-user"></i> <span>Staff</span></a> </li>
						<li> <a href="<?php echo e(route('admin.analytics')); ?>"><i class="fas fa-chart-pie"></i> <span>Analytics</span></a> </li>
                        <li> <a href="<?php echo e(url('/report')); ?>"><i class="fas fa-file-alt"></i> <span>Generate Report</span></a> </li>
						<li> <a href="<?php echo e(route('admin.calendar')); ?>"><i class="fas fa-calendar-alt"></i> <span>Calendar</span></a> </li>
					</ul>
				</div>
			</div>
		</div>
...
<?php /**PATH C:\xampp\htdocs\HMS\resources\views/Admin/layout.blade.php ENDPATH**/ ?>