...
<script>
    ...
    //revenue
        ...
        var data = {
            labels: <?php echo json_encode($lodges->pluck('area')); ?>, // Lodge names as labels
            datasets: [
                <?php $__currentLoopData = $revenues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodgeName => $revenue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        label: "<?php echo e($lodgeName); ?>",
    ...
    //Occupancy Rate
        ...
        var dates = <?php echo json_encode($dailyReports->pluck('report_date')->toArray()); ?>;

        var data = {
            labels: dates,
            datasets: [
                <?php $__currentLoopData = $occupancyRates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodgeName => $occupancyRate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        label: "<?php echo e($lodgeName); ?>",
    ...
    //Damage Rate
        ...
        var data = {
            labels: dates,
            datasets: [
                <?php $__currentLoopData = $damageRates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodgeName => $damageRate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        label: "<?php echo e($lodgeName); ?>",
                        data: <?php echo json_encode($damageRate); ?>,
                        borderColor: getRandomColor(), // Function to get random color for each lodge
                        fill: false
                    },
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    //Average Rate
        ...
        var data = {
            labels: <?php echo json_encode($lodges->pluck('area')); ?>, // Lodge names as labels
            datasets: [{
                data: <?php echo json_encode(array_values($averageRates)); ?>,
                backgroundColor: [
                    <?php $__currentLoopData = $averageRates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodgeName => $averageRate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        getRandomColor(),
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
    ...
    //Total Guest
        ...
        var data = {
            labels: <?php echo json_encode($lodges->pluck('area')); ?>, // Lodge names as labels
            datasets: [{
                data: <?php echo json_encode(array_values($totalGuests)); ?>,
                backgroundColor: [
                    <?php $__currentLoopData = $totalGuests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodgeName => $totalGuest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        getRandomColor(),
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ]
            }]
    ...
    //Damage Cost
        ...
        var data = {
            ...
            datasets: [{
                label: 'Damage Cost',
                data: <?php echo json_encode(array_values($damageCosts)); ?>,
                backgroundColor: [
                    <?php $__currentLoopData = $damageCosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodgeName => $damageCost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        getRandomColor(),
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
                borderColor: 'transparent',
    ...
    //Total Rooms
        ...
        var data = {
            labels: <?php echo json_encode($lodges->pluck('area')); ?>, // Lodge names as labels
            datasets: [{
                data: <?php echo json_encode(array_values($totalRooms)); ?>,
                backgroundColor: [
                    <?php $__currentLoopData = $totalRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lodgeName => $totalRoom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        getRandomColor(),
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ]
            }]
            ...
            datasets: [
                {
                    ...
                    borderWidth: 1,
                    data: <?php echo json_encode(array_column($totalCustomers, 'male')); ?>
                ...
                },
                {
                    ...
                    borderWidth: 1,
                    data: <?php echo json_encode(array_column($totalCustomers, 'female')); ?>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\HMS\resources\views/Admin/analytics.blade.php ENDPATH**/ ?>